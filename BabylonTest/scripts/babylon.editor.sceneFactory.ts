    ...
    export class SceneFactory {
        ...
        */
        ...
        static CreateSSAOPipeline(core: EditorCore, serializationObject: any = {}): SSAORenderingPipeline {
            ...
            var cameras: Camera[] = core.scene.cameras;
        ...
        static CreateVLSPostProcess(core: EditorCore, mesh: Mesh = null, serializationObject: any = {}): VolumetricLightScatteringPostProcess {
            var vls = new VolumetricLightScatteringPostProcess("vls", { passRatio: 0.5, postProcessRatio: 1.0 }, core.camera, mesh, 100);
        ...
        */
        ...
        static AddPointLight(core: EditorCore): PointLight {
            var light = new PointLight("New PointLight", new Vector3(10, 10, 10), core.scene);
        ...
        static AddDirectionalLight(core: EditorCore): DirectionalLight {
            var light = new DirectionalLight("New DirectionalLight", new Vector3(-1, -2, -1), core.scene);
        ...
        static AddSpotLight(core: EditorCore): SpotLight {
            var light = new SpotLight("New SpotLight", new Vector3(10, 10, 10), new Vector3(-1, -2, -1), 0.8, 2, core.scene);
            light.id = this.GenerateUUID();
        ...
        static AddHemisphericLight(core: EditorCore): HemisphericLight {
            var light = new HemisphericLight("New HemisphericLight", new Vector3(-1, -2, -1), core.scene);
            light.id = this.GenerateUUID();
        ...
        static AddBoxMesh(core: EditorCore): Mesh {
            var box = Mesh.CreateBox("New Box", 1.0, core.scene, false);
        ...
        static AddSphereMesh(core: EditorCore): Mesh {
            var sphere = Mesh.CreateSphere("New Sphere", 32, 1, core.scene, false);
        ...
        static AddPlaneMesh(core: EditorCore): Mesh {
            var plane = Mesh.CreatePlane("New Plane", 1, core.scene, false);
        ...
        static AddGroundMesh(core: EditorCore): Mesh {
            var ground = Mesh.CreateGround("New Ground", 10, 10, 32, core.scene, false);
        ...
        static AddHeightMap(core: EditorCore): Mesh {
            var heightMap = Mesh.CreateGroundFromHeightMap("New Height Map", "", 10, 10, 32, 1, 1, core.scene, false);
        ...
        static AddLensFlare(core: EditorCore, system: LensFlareSystem, size: number, position: number, color: any): LensFlare {
            ...
            var texture = Texture.CreateFromBase64String(buffer, "lens.png", core.scene);
        ...
        static AddReflectionProbe(core: EditorCore): ReflectionProbe {
            var rp = new ReflectionProbe("New Reflection Probe", 512, core.scene, true);
        ...
        static AddRenderTargetTexture(core: EditorCore): RenderTargetTexture {
            var rt = new RenderTargetTexture("New Render Target Texture", 512, core.scene, false);
        ...
        static AddSkyMesh(core: EditorCore): Mesh {
            var skyboxMaterial = new SkyMaterial("skyMaterial", core.scene);
            skyboxMaterial.backFaceCulling = false;

            var skybox = Mesh.CreateBox("skyBox", 1000.0, core.scene);
        ...
        static AddYardSkyMesh(core: EditorCore): Mesh {
            ...
            var skybox = Mesh.CreateSphere("skyBox", 3, 10 * multiplicationFactor, core.scene);
            skybox.id = this.GenerateUUID();
            skybox.material = skyboxMaterial;
        ...
        static AddYardDirectionalLight(core: EditorCore): DirectionalLight {
            var light = new DirectionalLight("New DirectionalLight", new Vector3(1, -1, -1), core.scene);
