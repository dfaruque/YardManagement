...
(function (port) {
    var yard = (function () {
        function yard() {
            ...
            this.engine.runRenderLoop(function () { _this.render(); });
            // Resize
            window.addEventListener("resize", function () {
                _this.engine.resize();
            });
        }
        yard.prototype.render = function () {
            this.scene.render();
        };
        yard.prototype.getGroundPosition = function (e) {
        ...
        yard.prototype.onPointerDown = function (evt) {
            if (evt.button !== 0) {
                return;
            }
...
//# sourceMappingURL=yard - Copy.js.map